    ...
    render() {
        return (
            <section id="delmember" className="example">
                ...
                <Delmember profile={"/img/pet/2/cover/0.png"} index={1} clickDel={this.clickDel.bind(this)} width="80" height="80" fontFamily="'Rubik', sans-serif" />
                <Delmember profile={"/img/pet/3/cover/0.png"} index={2} clickDel={this.clickDel.bind(this)} width="80" height="80" fontFamily="'Rubik', sans-serif" />
                <h4>
