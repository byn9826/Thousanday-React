...
class CommentlistEG extends Component {
    constructor(props) {
		...
		this.state = {
            comments: [
                ["This is first comment", "/img/user/1.jpg", "/user/1", "2017-01-01"],
                ["This is second comment", "/img/user/1.jpg", "/user/1", "2017-01-01"],
                ["This is third comment", "/img/user/1.jpg", "/user/1", "2017-01-01"]
            ],
            locker: "off"
		};
	}
    loadComment() {
        let newComment = [["This is fourth comment", "/img/user/1.jpg", "/user/1", "2017-01-01"]];
